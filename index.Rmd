...
## Finding the most exploiting region
...
For answering the question of which region that most exploits the slavery practice, we will not look at the number of black slaves in each region of the USA. Instead, we will see the trend of proportion from these three categories (white, black slaves, and black free), as seen in figure \@ref(fig:compare-region). In the figure, We are not covering census year of 1870 since the enslavement ended in that year.
