...
```{r demo1, fig.cap="Composition Based on Gender", out.height="100%", out.width="100%", echo = FALSE}
...
```{r region_census, fig.cap= "The Most Exploiting Region", echo = FALSE, message = FALSE}
...
```{r compareregion, fig.cap= "Composition of White and Black", fig.align="center", out.height="60%", out.width="60%", echo = FALSE}
ggarrange(N, M, S, W,
...
```{r south_all, fig.cap= "Proportion of White and Black", fig.align="center", out.height="60%", out.width="60%", echo = FALSE, message = FALSE}
...
Using these method, we can observe frequency of bad events for black people in USA. According to the analysis in figure \@ref(fig:sentiment_region), most nuance of observed events are filled with **negative, fear and anger**. Furthermore, most events recorded were occured in South region. It is not surprising given the previous finding that South region is a region that seems really exploiting slavery culture. 
