...
{\centering \includegraphics[width=0.6\linewidth,height=0.6\textheight]{index_files/figure-latex/compareregion-1} 
...
\{\centering \includegraphics[width=0.6\linewidth,height=0.6\textheight]{index_files/figure-latex/south_all-1}
